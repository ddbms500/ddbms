...
public:
    ...
    void generate_leaf_table(std::string site_name, int node_index);
    std::string request_remote_leaf_node(std::string sql_,std::string site_);
    void drop_temp_table();
    ...
    bool remote_execution_insert_delete(std::string sql_,std::string site_);
    ...
    void create_db_remote(std::string db_name);
    ...
    std::vector<std::string> temp_table_name;
};
